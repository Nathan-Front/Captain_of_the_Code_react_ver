    ...
    and discover how it would perform upon the React seas.
        ...
        Even the EmailJS treasure chest needed a few locks adjusted, as the sending of form messages required some extra tuning before it could function properly. In the end, the ship continued forward, stronger and better prepared for the adventures ahead.`,acquired:`AppContent rendering tecnique, backdrop page loader React version, EmailJS implementation React version`,treasure:`Proper setup of EmailJS in React, background image depending to what page is opened. Letter-typing effect in React`,weathered:`Tricksy (I had to change/adjust some of the code to just make it look or atleast the same from its previous version.)`,explore:`Explore the Island`,exploreImg:`./images/index/timeline/portfolio.webp`,exploreLink:``},{date:`Future`,dateTitle:`The Next`,themeTitle:`Future Projects`,tech:[{unknown:`unknown`}],log:`I am currently seeking Junior Frontend Developer
            ...
            a 'see you on the next horizon.'`,acquired:`Staying consistent with studying, even when tired,
                even if it is only for an hour each day.`,treasure:`Maintaining consistency while working a full-time job.`,weathered:`Having an impostor syndrome all the time.`,explore:`Explore the Island`,exploreImg:`./images/index/timeline/future.webp`,exploreLink:``}],c=r();function l(){let e=(0,i.c)(44),t;e[0]===Symbol.for(`react.memo_cache_sentinel`)?(t={},e[0]=t):t=e[0];let[n,r]=(0,a.useState)(t),l;e[1]===Symbol.for(`react.memo_cache_sentinel`)?(l=[],e[1]=l):l=e[1];let p=(0,a.useRef)(l),m=window.innerWidth<=845,h,g;e[2]===Symbol.for(`react.memo_cache_sentinel`)?(h=()=>{let e=new IntersectionObserver(e=>{e.forEach(e=>{let t=e.target.dataset.index;r(n=>({...n,[t]:e.isIntersecting}))})},{threshold:m?.05:.2,rootMargin:`100% 0px -100px 0px`});return p.current.forEach(t=>{t?.left&&e.observe(t.left),t?.right&&e.observe(t.right)}),()=>e.disconnect()},g=[],e[2]=h,e[3]=g):(h=e[2],g=e[3]),(0,a.useEffect)(h,g);let[_,v]=(0,a.useState)(!1),y=(0,a.useRef)(null),b,x;e[4]===Symbol.for(`react.memo_cache_sentinel`)?(b=()=>{let e=y.current;if(!e)return;let t=new IntersectionObserver(e=>{let[t]=e;t.isIntersecting?v(!0):v(!1)},{threshold:0});return t.observe(e),()=>{t.disconnect()}},x=[],e[4]=b,e[5]=x):(b=e[4],x=e[5]),(0,a.useEffect)(b,x);let[S]=(0,a.useState)(ee),[C,w]=(0,a.useState)(50),[T,E]=(0,a.useState)(`down`),D,O;e[6]===Symbol.for(`react.memo_cache_sentinel`)?(D=()=>{let e=window.scrollY,t=function(){let t=window.scrollY;w(50+t/(document.body.scrollHeight-window.innerHeight)),E(t>e?`down`:`up`),e=t};return window.addEventListener(`scroll`,t),()=>{window.removeEventListener(`scroll`,t)}},O=[],e[6]=D,e[7]=O):(D=e[6],O=e[7]),(0,a.useEffect)(D,O);let[k,A]=(0,a.useState)(null),j;e[8]===Symbol.for(`react.memo_cache_sentinel`)?(j=[],e[8]=j):j=e[8];let M=(0,a.useRef)(j),N;e[9]===k?N=e[10]:(N=e=>{let t=M.current[e];if(k!==null&&k!==e){let e=M.current[k];e&&(e.style.maxHeight=`100px`)}k===e?(t.style.maxHeight=`100px`,A(null)):(t.style.maxHeight=t.scrollHeight+`px`,A(e))},e[9]=k,e[10]=N);let P=N,F=`fly-text ${_?`active`:``}`,I;e[11]===S?I=e[12]:(I=S.map(f),e[11]=S,e[12]=I);let L;e[13]!==F||e[14]!==I?(L=(0,c.jsx)(`h2`,{id:`my-journey`,className:F,ref:y,children:I}),e[13]=F,e[14]=I,e[15]=L):L=e[15];let R;e[16]===Symbol.for(`react.memo_cache_sentinel`)?(R=o.map(d),e[16]=R):R=e[16];let z;e[17]===L?z=e[18]:(z=(0,c.jsx)(`div`,{className:`timeline-upper-container`,children:(0,c.jsx)(`div`,{className:`timeline-upper-sub-container`,children:(0,c.jsx)(`div`,{className:`timeline-upper-sub-inner-container`,children:(0,c.jsx)(`div`,{className:`padding-vertical`,children:(0,c.jsxs)(`div`,{className:`timeline-upper-sub-inner-content`,children:[L,R]})})})})}),e[17]=L,e[18]=z);let B;e[19]===Symbol.for(`react.memo_cache_sentinel`)?(B=(0,c.jsx)(`div`,{className:`padding-top`}),e[19]=B):B=e[19];let V=`timeline-progress-bar ${T}`,H=`voyage-ship ${T}`,U=`${C}vh`,W;e[20]===U?W=e[21]:(W={top:U},e[20]=U,e[21]=W);let G=T===`up`?`rotate(180deg)`:`rotate(0deg)`,K;e[22]===G?K=e[23]:(K=(0,c.jsx)(`img`,{src:`./images/index/boat.webp`,className:`boat`,style:{transform:G},alt:`Voyage Ship`,loading:`lazy`}),e[22]=G,e[23]=K);let q;e[24]!==H||e[25]!==W||e[26]!==K?(q=(0,c.jsx)(`div`,{className:H,style:W,children:K}),e[24]=H,e[25]=W,e[26]=K,e[27]=q):q=e[27];let J;e[28]!==V||e[29]!==q?(J=(0,c.jsx)(`div`,{className:`timeline-progress`,children:(0,c.jsx)(`div`,{className:V,children:q})}),e[28]=V,e[29]=q,e[30]=J):J=e[30];let Y;e[31]!==n||e[32]!==k||e[33]!==P?(Y=s.map((e,t)=>(0,c.jsxs)(`div`,{className:`timeline-item ${t==s.length-1?`last-timeline-container`:``}`,children:[(0,c.jsx)(`div`,{ref:e=>{p.current[t]={...p.current[t],trigger:e}},"data-index":t,className:`timeline-trigger`}),(0,c.jsx)(`div`,{ref:e=>{p.current[t]={...p.current[t],left:e}},className:`timeline-left ${n[t]?`dateSlide `:``}`,"data-index":t,children:(0,c.jsx)(`div`,{className:`timeline-date`,children:(0,c.jsxs)(`p`,{className:`timeline-date-text`,children:[e.date,(0,c.jsx)(`br`,{}),e.dateTitle]})})}),(0,c.jsx)(`div`,{className:`timeline-center`}),(0,c.jsxs)(`div`,{ref:e=>{p.current[t]={...p.current[t],right:e}},className:`timeline-right ${n[t]?`textSlide `:``}`,"data-index":t,children:[(0,c.jsx)(`div`,{className:`margin-bottom`,children:(0,c.jsxs)(`div`,{className:`timeline-text`,children:[(0,c.jsxs)(`h3`,{children:[(0,c.jsx)(`img`,{src:`./images/index/timeline/theme.webp`,alt:`theme-icon`,loading:`lazy`}),(0,c.jsx)(`span`,{children:e.themeTitle})]}),(0,c.jsxs)(`div`,{children:[(0,c.jsx)(`img`,{src:`./images/index/timeline/technologies.webp`,alt:`tech-icon`,className:`tech-icon`}),(0,c.jsx)(`ul`,{children:e.tech.map(u)})]}),(0,c.jsxs)(`div`,{className:`log-section`,children:[(0,c.jsx)(`img`,{src:`./images/index/timeline/captainLog.webp`,alt:`log icon`,className:`log-icon`,loading:`lazy`}),(0,c.jsx)(`p`,{ref:e=>M.current[t]=e,className:`log-text collapsed`,children:e.log}),(0,c.jsx)(`button`,{className:k===t?`read-more-btn ON`:`read-more-btn`,onClick:()=>P(t),children:k===t?`Read Less`:`Read More`})]}),(0,c.jsxs)(`div`,{children:[(0,c.jsx)(`img`,{src:`./images/index/timeline/acquired.webp`,alt:`skills icon`,className:`skills-icon`,loading:`lazy`}),(0,c.jsx)(`p`,{children:e.acquired})]}),(0,c.jsxs)(`div`,{children:[(0,c.jsx)(`img`,{src:`./images/index/timeline/treasureGain.webp`,alt:`treasure-icon`,className:`treasure-icon`,loading:`lazy`}),(0,c.jsx)(`p`,{children:e.treasure})]}),(0,c.jsxs)(`div`,{children:[(0,c.jsx)(`img`,{src:`./images/index/timeline/weathered.webp`,alt:`weathered icon`,className:`weathered-icon`,loading:`lazy`}),(0,c.jsx)(`p`,{children:e.weathered})]}),(0,c.jsx)(`p`,{})]})}),(0,c.jsxs)(`div`,{className:`timeline-image-wrap`,children:[(0,c.jsx)(`p`,{children:e.explore}),(0,c.jsx)(`a`,{href:e.exploreLink,target:`_blank`,rel:`noopener noreferrer`,className:`timeline-images`,children:(0,c.jsx)(`img`,{src:e.exploreImg,alt:`page-link-image`,loading:`lazy`})})]})]})]},t)),e[31]=n,e[32]=k,e[33]=P,e[34]=Y):Y=e[34];let X;e[35]!==J||e[36]!==Y?(X=(0,c.jsxs)(`div`,{className:`timeline-component`,children:[J,Y]}),e[35]=J,e[36]=Y,e[37]=X):X=e[37];let Z;e[38]===Symbol.for(`react.memo_cache_sentinel`)?(Z=(0,c.jsx)(`div`,{className:`padding-bottom`}),e[38]=Z):Z=e[38];let Q;e[39]===X?Q=e[40]:(Q=(0,c.jsx)(`div`,{className:`timeline-lower-container`,children:(0,c.jsxs)(`div`,{className:`timeline-lower-sub-container`,children:[B,X,Z]})}),e[39]=X,e[40]=Q);let $;return e[41]!==z||e[42]!==Q?($=(0,c.jsx)(c.Fragment,{children:(0,c.jsxs)(`section`,{className:`timeline-section`,id:`projects`,children:[z,Q]})}),e[41]=z,e[42]=Q,e[43]=$):$=e[43],$}function u(e,t){return(0,c.jsx)(`li`,{children:(0,c.jsx)(`span`,{className:`${Object.values(e)}-tag`,children:Object.values(e)})},t)}function d(e,t){return(0,c.jsx)(`p`,{children:e.text},t)}function f(e){let{char:t,index:n,style:r}=e;return(0,c.jsx)(`span`,{style:r,children:t===` `?`\xA0`:t},n)}function ee(){return[...`Captain's Voyage`].map(p)}function p(e,t){return{char:e,index:t,style:{"--x":`${Math.floor(Math.random()*600)-300}px`,"--y":`${Math.floor(Math.random()*600)-300}px`,"--rotate":`${Math.floor(Math.random()*360)-180}deg`}}}export{l as default};