export const description = [
    {text: "During the great plague, I first set sail into the seas of Web Development, revisiting the arts of HTML, CSS, and JavaScript. With plenty of time on my hands, I spent several months strengthening my understanding of the fundamentals and charting the beginnings of my journey."},
    {text: "As life gradually returned to normal and duties ashore grew heavier, my studies slowed. Long days of work often left little energy for further exploration, and my voyage drifted from its original course."},
    {text: "Yet about a year ago, the call of a new horizon grew too strong to ignore. Seeking fresh challenges and a renewed sense of accomplishment, I committed myself to learning programming once more. Since then, I have focused on steady progress, believing that even the smallest step forward each day brings me closer to my destination."},
    {text: "This website serves as my captain's log, a record of the knowledge I've gathered, the projects I've built, and the milestones I've reached along the way. It is both a showcase of my journey and a reminder that every great voyage begins with a single course set toward the horizon."}
];

export const timelineImg = [
        {themeImg: "./images/index/timeline/theme.webp", alt:"theme-icon"},
        {techImg: "", alt:"tech-icon"},
        {logImg: "", alt: "log-icon"},
        {acquiredImg: "", alt:"skill-icon"},
        {challengeImg: "", alt:"challenge-icon"},
        {weatheredImg: "", alt:"weathered-icon"}
];
export const timelineContent = [
    {date: "OCT - NOV 2025", 
    dateTitle: "The Beginning", 
    themeTitle: "Single-Page E-commerce Website",
    tech: [
        {html: "HTML"},
        {css: "CSS"},
    ...
    acquired: `Flexbox, CSS Grid, localStorage, floating navigation,
                signup/login functionality, adding/deleting products
                in a cart, and calculating the total order price.`,
    treasure: `Implementing responsive design, managing state with
    ...
    themeTitle: "Multi-Page Coffee Shop Website",
    tech: [
        {html: "HTML"},
        {css: "CSS"},
        {javascript: "JAVASCRIPT"}
    ],
    log: `After successfully establishing my first trading
    ...
    acquired: `Flexbox, CSS Grid, box-shadow and text-shadow effects,
    ...
    treasure: `Implementing responsive design, passing data between
    ...
    weathered: `Grueling (The touch-screen functionality was
    ...
    themeTitle: "Youtube Tutorial of React fundamentals",
    tech: [
        {react: "REACT"},
        {aws: "AWS"}
    ],
    log: `After successfully navigating the waters of multi-page
            ...
            digital seas.`,
    acquired: `Setting up a React development environment, deploying
                ...
                React applications.`,
    treasure: `Accustomed to navigating with vanilla JavaScript, I
    ...
    weathered: `Treacherous (I initially thought I could complete it
    ...
    themeTitle: "Multi-Page Hotel Website",
    tech: [
        {html: "HTML"},
        {css: "CSS"},
        {javascript: "JAVASCRIPT"}
    ],
    log: `This project was a much more formidable challenge than
    ...
    treasure: `I can honestly say that the design aspect of this
    ...
    themeTitle: "Single-Page E-commerce Website to React",
    tech: [
        {html: "HTML"},
        {css: "CSS"},
        {javascript: "JAVASCRIPT"},
    ...
    log: `After conquering the multi-page hotel website using
    ...
    acquired: `useState, useEffect, component-based architecture,
                lifting state up, passing props between components,
                ternary operators for conditional rendering.`,
    treasure: `Components base way of thinking, lifting up state,
                    installing the kit, and deploying a React project in
                    Github.`,
    weathered: `Perilous (I watch and searched more than I work here.
    ...
    themeTitle: "Multi-Page Coffee Shop Website to React",
    tech: [
        {html: "HTML"},
        {css: "CSS"},
        {javascript: "JAVASCRIPT"},
    ...
    log: `I thought I had a solid grasp of how React functioned
    ...
    acquired: `Lifting up state, passing props between components,
                BrowserRouter for routing, Github gh-pages for
                deployment and useRef hook.`,
    treasure: `Lifting up state, deploying a React project that uses
                    BrowserRouter, and installing the kit.`,
    weathered: `Intricate (I relied on AI a lot for this project,
    ...
    themeTitle: "Multi-Page Hotel Website to React",
    tech: [
        {html: "HTML"},
        {css: "CSS"},
        {javascript: "JAVASCRIPT"},
    ...
    log: `It was during this project that React's
    ...
    acquired: `HashRouter for routing, gh-pages for deployment,
                    separating more components into smaller pieces,
                    putting content inside a JS file and rendering it
                    through map function.`,
    treasure: `Deployment when using HashRouter, deploying the file
                    while it is inside a folder (deploying the folder
                    itself).`,
    weathered: `Treacherous (I encountered some issues when trying to
    ...
    themeTitle: "Multi-Page Jewelry Website",
    tech: [
        {html: "HTML"},
        {css: "CSS"},
        {javascript: "JAVASCRIPT"},
    ],
    log: `Following the completion of my previous React project,
    ...
    treasure: `Connecting the website to a Google sheet and using it
                    as a database, implementing the Paypal API for the
                    payment system.`,
    weathered: `Formidable (The most challenging parts of the project
    ...
    themeTitle: "Multi-Page Jewelry Website to React",
    tech: [
        {html: "HTML"},
        {css: "CSS"},
        {javascript: "JAVASCRIPT"},
    ...
    weathered: `Monumental (The most exciting projects so far and I
    ...
    log: `After completing my last voyage, I found myself wanting to create a
    ...
    acquired: `Image editing, CSS gradient and filter effects, backdrop when loading a
    ...
    {date: "Future", 
    dateTitle: "The Next", 
    themeTitle: "Future Projects",
    tech: [
        {unknown: "unknown"},
    ],
    log: `I am currently seeking Junior Frontend Developer
    ...
    acquired: `Staying consistent with studying, even when tired,
